...
- These are the minimum required vars need to setup to make Kay X Music functional.
...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [🤖 String Session](http://t.me/NichstringRobot) in Telegram.
...
- You can play tracks or playlists from spotify from Kay X Music
...
- If you plan to use Kay X Music with your own customized or modified code.
...
- You can change images which are used in Kay X Music.
- You can generate telegaph links from [KayXRobot](http://t.me/KayXRobot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [🤖 String Session](http://t.me/NichstringRobot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [🤖 String Session](http://t.me/NichstringRobot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [🤖 String Session](http://t.me/NichstringRobot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [🤖 String Session](http://t.me/NichstringRobot) in Telegram.
